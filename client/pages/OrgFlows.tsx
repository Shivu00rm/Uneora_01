...
export default function OrgFlows() {
  ...
  const filteredFlows = allFlows.filter((flow) => {
    ...
    const matchesType =
      selectedFlowType === "all" || flow.type === selectedFlowType;
    const matchesStatus =
  ...
  const successfulFlows = filteredFlows.filter(
    (f) => f.status === "success",
  ).length;
  const failedFlows = filteredFlows.filter((f) => f.status === "failed").length;
  const successRate =
    totalFlows > 0 ? Math.round((successfulFlows / totalFlows) * 100) : 0;
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
            ...
            >
              ...
              <SelectContent>
                ...
                <SelectItem value="inventory_update">
                  Inventory Updates
                </SelectItem>
                <SelectItem value="pos_transaction">
                  POS Transactions
                </SelectItem>
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <div>
                          ...
                          <Badge
                            variant={
                              flowTypeColors[
                                flow.type as keyof typeof flowTypeColors
                              ]
                            }
                            className="text-xs"
                          >
                    ...
                    <TableCell>
                      <div className="flex items-center gap-1">
                        ...
                        <Badge
                          variant={
                            flowStatusColors[
                              flow.status as keyof typeof flowStatusColors
                            ]
                          }
                        >
