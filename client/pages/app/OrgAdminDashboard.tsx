        ...
        <Card>
          <CardContent className="text-center py-8">
            <p className="text-gray-500">
              You don't have permission to view the organization dashboard.
            </p>
          </CardContent>
        </Card>
      </div>
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-7 gap-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {data.summary.activeEcommercePlatforms}
            </div>
            <p className="text-xs text-muted-foreground">
          ...
          <div className="flex items-center justify-end">
            <div className="flex items-center gap-2 text-sm">
              ...
              <select
                ...
                value={storesView}
                onChange={(e) => setStoresView(e.target.value as ViewMode)}
              >
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span
                          className={`font-medium ${store.alerts > 0 ? "text-yellow-600" : "text-green-600"}`}
                        >
                          {store.alerts} active
                        </span>
                      </div>
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium">
                          {new Date(store.lastActivity).toLocaleTimeString([], {
                            hour: "2-digit",
                            minute: "2-digit",
                          })}
                        </span>
          ...
          {storesView === "pie" && (
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Share of total revenue per store
                </CardDescription>
              </CardHeader>
              <CardContent style={{ height: 320 }}>
                <SafeResponsiveContainer width="100%" height="100%">
          ...
          <Card className="border-dashed border-2 hover:border-gray-400 transition-colors">
            <CardContent className="flex flex-col items-center justify-center py-12">
              ...
              <p className="text-gray-500 text-center mb-4">
                Expand your business by adding a new physical or online store
                location
              </p>
              <Button asChild>
          ...
          <div className="flex items-center justify-end">
            <div className="flex items-center gap-2 text-sm">
              ...
              <select
                className="border rounded px-2 py-1 text-sm"
                value={channelsView}
                onChange={(e) => setChannelsView(e.target.value as ViewMode)}
              >
                <option value="cards">Cards</option>
                <option value="bar">Bar</option>
                <option value="pie">Pie</option>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-between text-sm">
                      ...
                      <span
                        className={`font-medium ${platform.errors > 0 ? "text-red-600" : "text-green-600"}`}
                      >
          ...
          {channelsView === "pie" && (
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Share of total revenue per channel
                </CardDescription>
              </CardHeader>
              <CardContent style={{ height: 320 }}>
                <SafeResponsiveContainer width="100%" height="100%">
        ...
        <TabsContent value="activity" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Latest events across all stores and channels
              </CardDescription>
            </CardHeader>
            <CardContent>
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center gap-2 mt-1">
                        ...
                        <Badge variant="outline" className="text-xs">
                          {
                            data.stores.find((s) => s.id === activity.storeId)
                              ?.name
                          }
                        </Badge>
                      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <Card className="hover:shadow-lg transition-shadow cursor-pointer">
              <CardContent className="flex flex-col items-center text-center p-6">
                ...
                <p className="text-sm text-gray-600 mb-4">
                  Add, edit, or configure store locations
                </p>
            ...
            <Card className="hover:shadow-lg transition-shadow cursor-pointer">
              <CardContent className="flex flex-col items-center text-center p-6">
                ...
                <p className="text-sm text-gray-600 mb-4">
                  Manage online platform integrations
                </p>
                <Button asChild className="w-full">
          ...
          <Card>
            ...
            <CardContent>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                ...
                <div className="text-center">
                  <div className="text-2xl font-bold text-yellow-600">
                    {data.quickStats.pendingShipments}
                  </div>
                  <div className="text-sm text-gray-600">Pending Shipments</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-red-600">
                    {data.quickStats.lowStockItems}
                  </div>
                  <div className="text-sm text-gray-600">Low Stock Items</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-orange-600">
                    {data.quickStats.syncErrors}
                  </div>
